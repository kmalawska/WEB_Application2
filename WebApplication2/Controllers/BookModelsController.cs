...
namespace WebApplication2.Controllers
{
    public class BookModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Author")] BookModel bookModel)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var bookModel = await _context.Books.SingleOrDefaultAsync(m => m.BookId == id);
            if (bookModel == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Author")] BookModel bookModel)
        {
